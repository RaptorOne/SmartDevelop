...
namespace SmartDevelop.TokenizerBase.IA.Indentation
{
    using System;
	...
	/// <summary>
	/// Smart indentation for IA.
	/// </summary>
	public class IAIndentationStrategy : DefaultIndentationStrategy
	{
		/// <summary>
		/// Creates a new CSharpIndentationStrategy.
		/// </summary>
		public IAIndentationStrategy()
		{
		}
		...
		/// </summary>
        public IAIndentationStrategy(TextEditorOptions options)
		{
